Dame el main.py corregido entonces:
   ...
   try:
       ...
       with XlsmSessionWriter(macro_path) as writer:
           ...
           try:
               ...
               logging.exception("No se pudieron escribir campos RBM cónyuge en hoja Inicio: %r", e)
           ...
           try:
               ...
               logging.exception("No se pudo escribir tabla CEM cónyuge en hoja Inicio: %r", e)
           # ------------------ Imágenes ------------------
           # SBS (titular)
