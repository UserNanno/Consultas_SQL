Mira me compartieron esto en pyspark
...
Pero quiero hacerlo en SQL nomas
...
SELECT
	...
	END) AS LEAD_CEF
FROM CATALOG_LHCL_PROD_BCP.BCP_DDV_RBMRBMPER_MODELOGESTION_VU.MD_EVALUACIONSOLICITUDCREDITO
WHERE TIPPRODUCTOSOLICITUDRBM = 'CC' AND DESCANALVENTARBMPER NOT IN ('YAPE', 'OTROS') AND CODMESEVALUACION = 202001;

y QUIERO hacer lo de saber si hay duplicados por CODINTERNOCOMPUTACIONAL y CODEVALUACIONSOLICITUD asi como se hacia en pypsark.

Como seria?

Actualmente se hace para 1 mes, como sería para todos los meses que yo diga? 
