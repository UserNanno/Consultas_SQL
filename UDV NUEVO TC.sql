...
BASE_MESREF AS (
  SELECT
    b.*,
    CAST(date_format(add_months(to_date(concat(CAST(b.CODMESSOLICITUDEVALUATION AS STRING),'01'),'yyyyMMdd'),-1),'yyyyMM') AS INT) AS CODMES_SBS_MENOS_1,
    b.CODMESSOLICITUDEVALUATION AS CODMES_SBS_MES
  FROM BASE_FLAGS b
),
...
SELECT *
FROM BASE_SBS
WHERE CODMESSOLICITUDEVALUATION BETWEEN 202501 AND 202512
