...
# ---------- PATHS ----------
BASE_DIR_ORGANICO = "abfss://bcp-edv-rbmbdn@adlscu1lhclbackp05.dfs.core.windows.net/T72496/CARGA/ORGANICO/1n_Apps_*.csv"
...
AnalysisException: [UNRESOLVED_COLUMN.WITH_SUGGESTION] A column or function parameter with name `CODMES` cannot be resolved. Did you mean one of the following? [`Mail`, `Largo`, `Title`, `AÃ±oMes`, `Created`].;
'Project ['CODMES AS CODMES#47, 'Matrícula AS MATORGANICO#48, 'Nombre Completo AS NOMBRECOMPLETO#49, 'Correo electronico AS CORREO#50, 'Fecha Ingreso AS FECINGRESO#51, 'Matrícula Superior AS MATSUPERIOR#52]
+- Relation [Title#23,FechaAsignacion#24,Tipo de Producto#25,ResultadoAnalista#26,ResultadoCDA#27,Motivo DerivaciÃ³n - Centralizado#28,Analista#29,Motivo Resultado Analista#30,Largo#31,AÃ±oMes#32,Created#33,Mail#34] csv


en PATH_SF_ESTADOS no me sale error
...
df_salesforce_estados = (
    ...
    Mis csv de organico vienen asi Matrícula;Nombre Completo;Matrícula Superior;Fecha Ingreso;Correo electronico;CODMES

    y tienen la nomenclatura de 1n_Activos_202501.csv, 1n_Activos_202502.csv y asi hasta 1n_Activos_202512.csv
